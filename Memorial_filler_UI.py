...
opcoes_mod = ["Trina Solar 695W", "Canadian Solar", "Astronergy 375W", "Gokin 585W", "Hanersun 585W", "Gokin 700W", "Astronergy 600W", "ZnShine 700W", "Hanersun 610W", "Honor 700W", "Gokin 610W","Trina Solar 400W"]
mod_sel = st.selectbox("Escolha o tipo de módulo:", opcoes_mod)
tipo_mod = opcoes_mod.index(mod_sel) + 1

opcoes_inv = ["Growatt NEO 2250M-X2", "Sungrow", "Hoymiles MI-1500/700", "Hyxipower HYX-M2000-SW", "Solis 6 kW", "Hoymiles HMS-2000-4T", "Growatt NEO 2000M-X", "SAJ R6-20K-T3-32-LV"]
